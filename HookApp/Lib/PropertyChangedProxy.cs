...
namespace HookApp.Lib
{
	...
	public class PropertyChangedProxy<TSource, TPropType> where TSource : INotifyPropertyChanged
	{
		...
		private readonly Action<object> _onPropertyChanged;
		...
		public PropertyChangedProxy(TSource source, Expression<Func<TSource, TPropType>> selectorExpression, Action<object> onPropertyChanged)
		{
			_source = source;
